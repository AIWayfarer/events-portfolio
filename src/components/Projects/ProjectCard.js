...
const ProjectCard = ({ data, index }) => {
  ...
  return (
    <Link
      ...
      className="group shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] relative h-[350px] w-[350px] md:h-[450px] md:w-[450px] overflow-hidden cursor-pointer"
    >
      <motion.img
